        ...
        <div className=" pt-2 sm:pt-5 relative"  >
          ...
          <div className="grid mt-8 grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
            <div className="bg-gray-700 p-5 flex-1 rounded-2xl relative h-30 w-50 sm:min-h-40 sm:w-80 ">
              <h4 className="absolute top-4 left-5  font-bold text-[16px] sm:text-xl  ">Total Projek</h4>
              <p className="absolute bottom-3 right-5 font-black text-5xl sm:text-6xl ">{totalProyek}</p>
            </div>
            <div className="bg-gray-700 p-5 flex-1 rounded-2xl relative h-30 w-50 sm:min-h-40 sm:w-80 ">
              <h4 className="absolute top-4 left-5  font-bold text-[16px] sm:text-xl  ">Tugas Aktif</h4>
              <p className="absolute bottom-3 right-5 font-black text-5xl sm:text-6xl ">{tugasAktif}</p>
            </div>
            <div className="bg-gray-700 p-5 flex-1 rounded-2xl relative h-30 w-50 sm:min-h-40 sm:w-80 ">
              <h4 className="absolute top-4 left-5  font-bold text-[16px] sm:text-xl  ">Selesai</h4>
              <p className="absolute bottom-3 right-5 font-black text-5xl sm:text-6xl ">{tugasSelesai}</p>
            </div>
          </div>
